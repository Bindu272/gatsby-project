...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9581);
...
// EXTERNAL MODULE: external "C:\\Users\\bpatil\\Desktop\\react\\Gatsby\\tutorial\\node_modules\\react\\index.js"
var external_C_Users_bpatil_Desktop_react_Gatsby_tutorial_node_modules_react_index_js_ = __webpack_require__(9581);
var external_C_Users_bpatil_Desktop_react_Gatsby_tutorial_node_modules_react_index_js_default = /*#__PURE__*/__webpack_require__.n(external_C_Users_bpatil_Desktop_react_Gatsby_tutorial_node_modules_react_index_js_);
;// CONCATENATED MODULE: ./src/components/Footer.js
const Footer=()=>{return/*#__PURE__*/external_C_Users_bpatil_Desktop_react_Gatsby_tutorial_node_modules_react_index_js_default().createElement("footer",{className:"page-footer"},/*#__PURE__*/external_C_Users_bpatil_Desktop_react_Gatsby_tutorial_node_modules_react_index_js_default().createElement("p",null,"\xA9 ",new Date().getFullYear()," ",/*#__PURE__*/external_C_Users_bpatil_Desktop_react_Gatsby_tutorial_node_modules_react_index_js_default().createElement("span",null,"Veggie foodie")," Built with",/*#__PURE__*/external_C_Users_bpatil_Desktop_react_Gatsby_tutorial_node_modules_react_index_js_default().createElement("a",{href:"https://www.gatsbyjs.com/"}," Gatsby")));};/* harmony default export */ const components_Footer = (Footer);
...
function FiAlignJustify (props) {
  return (0,esm/* GenIcon */.w_)({"tag":"svg","attr":{"viewBox":"0 0 24 24","fill":"none","stroke":"currentColor","strokeWidth":"2","strokeLinecap":"round","strokeLinejoin":"round"},"child":[{"tag":"line","attr":{"x1":"21","y1":"10","x2":"3","y2":"10"}},{"tag":"line","attr":{"x1":"21","y1":"6","x2":"3","y2":"6"}},{"tag":"line","attr":{"x1":"21","y1":"14","x2":"3","y2":"14"}},{"tag":"line","attr":{"x1":"21","y1":"18","x2":"3","y2":"18"}}]})(props);
};
...
;// CONCATENATED MODULE: ./src/assest/images/logo.png
/* harmony default export */ const logo = (__webpack_require__.p + "static/logo-5ebcdb42edc2d69aba3c31a8fe0cddd1.png");
;// CONCATENATED MODULE: ./src/components/Navbar.js
const Navbar=()=>{const{0:show,1:setShow}=(0,external_C_Users_bpatil_Desktop_react_Gatsby_tutorial_node_modules_react_index_js_.useState)(false);return/*#__PURE__*/external_C_Users_bpatil_Desktop_react_Gatsby_tutorial_node_modules_react_index_js_default().createElement("nav",{className:"navbar"},/*#__PURE__*/external_C_Users_bpatil_Desktop_react_Gatsby_tutorial_node_modules_react_index_js_default().createElement("div",{className:"nav-center"},/*#__PURE__*/external_C_Users_bpatil_Desktop_react_Gatsby_tutorial_node_modules_react_index_js_default().createElement("div",{className:"nav-header"},/*#__PURE__*/external_C_Users_bpatil_Desktop_react_Gatsby_tutorial_node_modules_react_index_js_default().createElement(gatsby_browser_entry.Link,{to:"/"},/*#__PURE__*/external_C_Users_bpatil_Desktop_react_Gatsby_tutorial_node_modules_react_index_js_default().createElement("img",{src:logo,alt:"..."})),/*#__PURE__*/external_C_Users_bpatil_Desktop_react_Gatsby_tutorial_node_modules_react_index_js_default().createElement("button",{className:"nav-btn",onClick:()=>setShow(!show)},/*#__PURE__*/external_C_Users_bpatil_Desktop_react_Gatsby_tutorial_node_modules_react_index_js_default().createElement(FiAlignJustify,null))),/*#__PURE__*/external_C_Users_bpatil_Desktop_react_Gatsby_tutorial_node_modules_react_index_js_default().createElement("div",{className:show?"nav-links show-links":"nav-links"},/*#__PURE__*/external_C_Users_bpatil_Desktop_react_Gatsby_tutorial_node_modules_react_index_js_default().createElement(gatsby_browser_entry.Link,{to:"/",className:"nav-link",activeClassName:"active-link",onClick:()=>setShow(false)},"home"),/*#__PURE__*/external_C_Users_bpatil_Desktop_react_Gatsby_tutorial_node_modules_react_index_js_default().createElement(gatsby_browser_entry.Link,{to:"/Recipe",className:"nav-link",activeClassName:"active-link",onClick:()=>setShow(false)},"Recipe"),/*#__PURE__*/external_C_Users_bpatil_Desktop_react_Gatsby_tutorial_node_modules_react_index_js_default().createElement(gatsby_browser_entry.Link,{to:"/Tags",className:"nav-link",activeClassName:"active-link",onClick:()=>setShow(false)},"tags"),/*#__PURE__*/external_C_Users_bpatil_Desktop_react_Gatsby_tutorial_node_modules_react_index_js_default().createElement(gatsby_browser_entry.Link,{to:"/about",className:"nav-link",activeClassName:"active-link",onClick:()=>setShow(false)},"about"),/*#__PURE__*/external_C_Users_bpatil_Desktop_react_Gatsby_tutorial_node_modules_react_index_js_default().createElement("div",{className:"nav-link contact-link"},/*#__PURE__*/external_C_Users_bpatil_Desktop_react_Gatsby_tutorial_node_modules_react_index_js_default().createElement(gatsby_browser_entry.Link,{to:"/contact",className:"btn",onClick:()=>setShow(false)},"contact")))));};/* harmony default export */ const components_Navbar = (Navbar);
;// CONCATENATED MODULE: ./src/components/Layout.js
const Layout=({children})=>{return/*#__PURE__*/external_C_Users_bpatil_Desktop_react_Gatsby_tutorial_node_modules_react_index_js_default().createElement((external_C_Users_bpatil_Desktop_react_Gatsby_tutorial_node_modules_react_index_js_default()).Fragment,null,/*#__PURE__*/external_C_Users_bpatil_Desktop_react_Gatsby_tutorial_node_modules_react_index_js_default().createElement(components_Navbar,null),children,/*#__PURE__*/external_C_Users_bpatil_Desktop_react_Gatsby_tutorial_node_modules_react_index_js_default().createElement(components_Footer,null));};/* harmony default export */ const components_Layout = (Layout);
...
/* harmony export */ });
/* harmony import */ var gatsby__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(9572);
/* harmony import */ var gatsby_plugin_image__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(3040);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(9581);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var slugify__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(1304);
...
const Recipelist=({recipes=[]})=>{return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div",{className:"recipes-list"},recipes.map(recipe=>{const{id,title,image,prepTime,cookTime}=recipe;const pathToImage=(0,gatsby_plugin_image__WEBPACK_IMPORTED_MODULE_3__/* .getImage */ .gJ)(image);const slug=slugify__WEBPACK_IMPORTED_MODULE_2___default()(title,{lower:true});return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(gatsby__WEBPACK_IMPORTED_MODULE_0__.Link,{key:id,to:`/${slug}`,className:"recipe"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(gatsby_plugin_image__WEBPACK_IMPORTED_MODULE_3__/* .GatsbyImage */ .HN,{image:pathToImage,className:"recipe-img",alt:title}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("h5",null,title),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("p",null,"Prep : ",prepTime,"min | Cook : ",cookTime,"min"));}));};/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Recipelist);
...
const query="2468095761";const SEO=({title,description})=>{const{site}=(0,gatsby__WEBPACK_IMPORTED_MODULE_2__.useStaticQuery)(query);const metaDescription=description||site.siteMetadata.description;return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_helmet__WEBPACK_IMPORTED_MODULE_1__.Helmet,{htmlAttributes:{lang:"en"},title:`${title} | ${site.siteMetadata.title}`,meta:[{name:`description`,content:metaDescription}]});};/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (SEO);
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ pages_Recipe)
});

// EXTERNAL MODULE: external "C:\\Users\\bpatil\\Desktop\\react\\Gatsby\\tutorial\\node_modules\\react\\index.js"
var external_C_Users_bpatil_Desktop_react_Gatsby_tutorial_node_modules_react_index_js_ = __webpack_require__(9581);
var external_C_Users_bpatil_Desktop_react_Gatsby_tutorial_node_modules_react_index_js_default = /*#__PURE__*/__webpack_require__.n(external_C_Users_bpatil_Desktop_react_Gatsby_tutorial_node_modules_react_index_js_);
// EXTERNAL MODULE: ./src/components/Recipelist.js
var Recipelist = __webpack_require__(2207);
// EXTERNAL MODULE: ./src/utils/setupTags.js
var setupTags = __webpack_require__(6147);
// EXTERNAL MODULE: ./.cache/gatsby-browser-entry.js + 5 modules
var gatsby_browser_entry = __webpack_require__(9572);
...
;// CONCATENATED MODULE: ./src/components/TagsList.js
const TagsList=({recipes})=>{const newTags=(0,setupTags/* default */.Z)(recipes);return/*#__PURE__*/external_C_Users_bpatil_Desktop_react_Gatsby_tutorial_node_modules_react_index_js_default().createElement("div",{className:"tag-container"},/*#__PURE__*/external_C_Users_bpatil_Desktop_react_Gatsby_tutorial_node_modules_react_index_js_default().createElement("h4",{className:"categories"},"categories"),/*#__PURE__*/external_C_Users_bpatil_Desktop_react_Gatsby_tutorial_node_modules_react_index_js_default().createElement("div",{className:"tags-list"},newTags.map((tag,index)=>{const[text,value]=tag;const slug=slugify_default()(text,{lower:true});return/*#__PURE__*/external_C_Users_bpatil_Desktop_react_Gatsby_tutorial_node_modules_react_index_js_default().createElement("div",null,/*#__PURE__*/external_C_Users_bpatil_Desktop_react_Gatsby_tutorial_node_modules_react_index_js_default().createElement(gatsby_browser_entry.Link,{to:`/tags/${slug}`,key:index,className:"list"},text," (",value,")"));})));};/* harmony default export */ const components_TagsList = (TagsList);
;// CONCATENATED MODULE: ./src/components/AllRecipe.js
const query="1058133876";const AllRecipe=()=>{const data=(0,gatsby_browser_entry.useStaticQuery)(query);const recipes=data.allContentfulRecipe.nodes;return/*#__PURE__*/external_C_Users_bpatil_Desktop_react_Gatsby_tutorial_node_modules_react_index_js_default().createElement("section",{className:"recipes-container"},/*#__PURE__*/external_C_Users_bpatil_Desktop_react_Gatsby_tutorial_node_modules_react_index_js_default().createElement(components_TagsList,{recipes:recipes}),/*#__PURE__*/external_C_Users_bpatil_Desktop_react_Gatsby_tutorial_node_modules_react_index_js_default().createElement(Recipelist/* default */.Z,{recipes:recipes}));};/* harmony default export */ const components_AllRecipe = (AllRecipe);
// EXTERNAL MODULE: ./src/components/Layout.js + 4 modules
var Layout = __webpack_require__(3923);
// EXTERNAL MODULE: ./src/components/SEO.js
var SEO = __webpack_require__(8454);
;// CONCATENATED MODULE: ./src/pages/Recipe.js
const Recipe=()=>{return/*#__PURE__*/external_C_Users_bpatil_Desktop_react_Gatsby_tutorial_node_modules_react_index_js_default().createElement(Layout/* default */.Z,null,/*#__PURE__*/external_C_Users_bpatil_Desktop_react_Gatsby_tutorial_node_modules_react_index_js_default().createElement(SEO/* default */.Z,{title:"Recipes"}),/*#__PURE__*/external_C_Users_bpatil_Desktop_react_Gatsby_tutorial_node_modules_react_index_js_default().createElement("main",{className:"page"},/*#__PURE__*/external_C_Users_bpatil_Desktop_react_Gatsby_tutorial_node_modules_react_index_js_default().createElement(components_AllRecipe,null)));};/* harmony default export */ const pages_Recipe = (Recipe);
...
/* harmony export */   "Z": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
const setupTags=recipes=>{const allTags={};recipes.forEach(recipe=>{recipe.content.tags.forEach(tag=>{if(allTags[tag]){allTags[tag]=allTags[tag]+1;}else{allTags[tag]=1;}});});const newTags=Object.entries(allTags).sort((a,b)=>{const[firstTag]=a;const[secondTag]=b;return firstTag.localeCompare(secondTag);});return newTags;};/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (setupTags);
...
var IconContext = (external_C_Users_bpatil_Desktop_react_Gatsby_tutorial_node_modules_react_index_js_default()).createContext && external_C_Users_bpatil_Desktop_react_Gatsby_tutorial_node_modules_react_index_js_default().createContext(DefaultContext);
...
function Tree2Element(tree) {
  return tree && tree.map(function (node, i) {
    return external_C_Users_bpatil_Desktop_react_Gatsby_tutorial_node_modules_react_index_js_default().createElement(node.tag, __assign({
      key: i
...
function GenIcon(data) {
  return function (props) {
    return external_C_Users_bpatil_Desktop_react_Gatsby_tutorial_node_modules_react_index_js_default().createElement(IconBase, __assign({
...
function IconBase(props) {
  var elem = function (conf) {
    ...
    return external_C_Users_bpatil_Desktop_react_Gatsby_tutorial_node_modules_react_index_js_default().createElement("svg", __assign({
      stroke: "currentColor",
      fill: "currentColor",
      strokeWidth: "0"
    ...
    }), title && external_C_Users_bpatil_Desktop_react_Gatsby_tutorial_node_modules_react_index_js_default().createElement("title", null, title), props.children);
  };

  return IconContext !== undefined ? external_C_Users_bpatil_Desktop_react_Gatsby_tutorial_node_modules_react_index_js_default().createElement(IconContext.Consumer, null, function (conf) {
    return elem(conf);
  }) : elem(DefaultContext);
}
